        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                isPremium ? 'Você é Premium!' : 'Sinal Verde Premium',
              ...
              if (isPremium) ...[
                _buildBenefitItem(Icons.verified_rounded, 'A assinatura está ativa'),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: isPremium
                      ? null
                      : () async {
                          final success = await context.read<ProfileViewModel>().upgradeToPremium();
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    disabledBackgroundColor: const Color(0xFF1B7E3D).withValues(alpha: 0.35),
