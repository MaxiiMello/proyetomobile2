                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildStatCard('Viagens', '${viewModel.travelCount}'),
                        _buildStatCard('Km Percorrido', '${viewModel.totalKilometers.toStringAsFixed(0)}'),
                        _buildStatCard('Tempo Total', viewModel.totalTime),
                      ],
                    ),
                  ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Renova em ${viewModel.renewalDays}',
                                  style: TextStyle(
                                    fontSize: 12,
                                    color: Colors.grey[700],
                                  ),
